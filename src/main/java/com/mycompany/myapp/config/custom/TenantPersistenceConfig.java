...
@EnableJpaRepositories(
    basePackages = { "${spring.tenancy.repository.packeges}"},
...
public class TenantPersistenceConfig {
    ...
    public TenantPersistenceConfig(
        ...
        @Value("${spring.tenancy.entityManager.packages}")
    ...
    public LocalContainerEntityManagerFactoryBean tenantEntityManagerFactory(
        @Qualifier("tenantDynamicDataSourceConnectionProvider") MultiTenantConnectionProvider connectionProvider,
        @Qualifier("tenantCurrentIdentifierResolver") CurrentTenantIdentifierResolver tenantResolver) {
